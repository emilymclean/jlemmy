...
public class CommentReplyView {
	...
	public CommentReplyView(CommentReply commentReply, Comment comment, Person creator, Post post, Community community, Person recipient, CommentAggregates counts, boolean creatorBannedFromCommunity, boolean bannedFromCommunity, boolean creatorIsModerator, boolean creatorIsAdmin, SubscribedType subscribed, boolean saved, boolean creatorBlocked, long myVote) {
